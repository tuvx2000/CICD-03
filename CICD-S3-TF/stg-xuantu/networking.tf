...
module "vpc" {
  ...
  public_subnet_tags = merge(
    var.tags,
    {
      "Name"                                      = "Staging-Module-public-subnet"
  ...
  private_subnet_tags = merge(
    var.tags,
    {
      "Name"                                      = "Staging-Module-private-subnet"
      "kubernetes.io/cluster/${var.cluster_name}" = "shared"
  ...
  database_subnet_tags = merge(
    var.tags,
    {
      "Name" = "Staging-Module-database-subnet"
    }
  )
  ...
  public_route_table_tags = merge(
    var.tags,
    {
      "Name" = "Staging-Module-public-subnet-rtable"
    }
  )
  private_route_table_tags = merge(
    var.tags,
    {
      "Name" = "Staging-Module-private-subnet-rtable"
    }
  )
}